...
1. **选择合适的提示词**：根据具体任务选择相应的提示词模板
2. **提供完整上下文**：将相关文档和代码一起提供给 AI
3. **验证 AI 输出**：不要盲目信任，要验证 AI 的理解和输出
4. **迭代优化**：根据 AI 反馈逐步完善文档和代码
5. **保持更新**：随着项目演进，定期更新文档和提示词

## 进阶技巧

1. **组合使用**：可以组合多个提示词，形成完整的工作流
2. **自定义调整**：根据项目特点调整提示词的内容和侧重点
3. **建立模板库**：将常用的提示词保存为团队模板
4. **持续改进**：根据使用效果不断优化提示词
